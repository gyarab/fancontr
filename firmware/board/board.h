 ...
 * Board identifier.
 */
#define BOARD_FANCONTR
#define BOARD_NAME              "Fancontr"
...
/*
 * Port A setup.
 * PA15 - Push Pull output  (USB switch).
 */
 ...
 * Fan PWM pins (TODO: Document)
 */
#define VAL_GPIOBCRL            0x8BBB388B      /*  PB7...PB0 */
#define VAL_GPIOBCRH            0x47B84BBB      /* PB15...PB8 */
 ...
 */
#define usb_lld_connect_bus(usbp) palSetPad(GPIOA, GPIOA_USBDP_PULLUP)

/*
 * USB bus de-activation macro, required by the USB driver.
 */
#define usb_lld_disconnect_bus(usbp) palClearPad(GPIOA, GPIOA_USBDP_PULLUP)
